...
(function (global) {
  ...
  var TOP = {
    guest: [
      ...
      { to: "/trips.html", label: "Trips", icon: "trips" },
      { to: "/bookings.html", label: "Bookings", icon: "bookings" },
      { to: "/flight-booking.html", label: "Flights", icon: "bookings" },
      { to: "/chat.html", label: "AI Chat", icon: "reviews" },
      { to: "/notifications.html", label: "Inbox", icon: "portal" },
      { to: "/weather.html", label: "Weather", icon: "weather" },
      { to: "/plans.html", label: "Plans", icon: "plans" },
      { to: "/favourites.html", label: "Favourites", icon: "favourites" },
    ...
    user: [
      ...
      { to: "/restaurants.html", label: "Restaurants", icon: "restaurants" },
      { to: "/destinations.html", label: "Destinations", icon: "destinations" },
      { to: "/surveys.html", label: "Surveys", icon: "surveys" },
      { to: "/trips.html", label: "Trips", icon: "trips" },
      { to: "/bookings.html", label: "Bookings", icon: "bookings" },
      { to: "/flight-booking.html", label: "Flights", icon: "bookings" },
      { to: "/chat.html", label: "AI Chat", icon: "reviews" },
      { to: "/notifications.html", label: "Inbox", icon: "portal" },
      { to: "/report-agency.html", label: "Report", icon: "contact" },
      { to: "/weather.html", label: "Weather", icon: "weather" },
      { to: "/plans.html", label: "Plans", icon: "plans" },
      { to: "/favourites.html", label: "Favourites", icon: "favourites" },
      { to: "/my-reviews.html", label: "Reviews", icon: "myreviews" },
      { to: "/about.html", label: "About", icon: "about" },
      { to: "/contact.html", label: "Contact", icon: "contact" },
      { to: "/help.html", label: "Help", icon: "settings" },
    ],
  ...
  var ADMIN_ITEMS = [
    { section: null, items: [{ href: "index.html", label: "Dashboard", icon: "dashboard" }] },
    {
      section: "Content",
      items: [
        { href: "users.html", label: "Users", icon: "users" },
        { href: "trips.html", label: "Trips", icon: "trips" },
        ...
        { href: "reviews.html", label: "Reviews", icon: "reviews" },
        { href: "agency-requests.html", label: "Agency Requests", icon: "agency" },
        { href: "contacts.html", label: "Contacts", icon: "contacts" },
      ],
    },
    {
      section: "Operations",
      items: [
        ...
        { href: "reports.html", label: "Reports", icon: "dashboard" },
        { href: "settings.html", label: "Settings", icon: "settings" },
        { href: "notifications.html", label: "Notif Logs", icon: "dashboard" },
        { href: "flags.html", label: "Moderation", icon: "users" },
      ],
    },
  ];

  /* agency role — assignments + customer tools (no catalog pages built yet) */
  var AGENCY_ITEMS = [
    {
      section: null,
      items: [
        { href: "assignments.html", label: "My Assignments", icon: "assignments" },
        { href: "../home.html", label: "Customer site", icon: "portal" },
      ],
    },
  ];
  ...
  function renderItem(item, base) {
    ...
    if (item.icon) {
      return '<a href="' + href + '" class="nav-item" title="' + item.label + '">' +
        '<span class="nav-icon">' + ICONS[item.icon] + "</span>" +
        '<span class="nav-label">' + item.label + "</span></a>";
    }
    return '<a href="' + href + '" class="nav-item">' + item.label + "</a>";
  }
