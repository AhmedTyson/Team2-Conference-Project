  ...
  var ADMIN_ITEMS = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "flags.html", label: "Reported Content & Chats", icon: "flags", badgeKey: "flags" },
        { href: "../app/chat.html?mentor=1", label: "Moderation Chat Console", icon: "reviews" },
  ...
  var AGENCY_ITEMS = [
    {
      ...
      items: [
        ...
        { href: "../app/chat.html", label: "Customer Chat", icon: "reviews" },
