...
class FlagRepository implements FlagRepositoryInterface
{
    ...
    {
        return Flag::with(['reporter.roles', 'reviewer', 'agencyAssignment.customer', 'agencyAssignment.agency'])->latest()->get();
    }

    public function getById(Flag $flag): Flag
    {
        return $flag->load(['reporter.roles', 'reviewer', 'agencyAssignment.customer', 'agencyAssignment.agency']);
    }
}
