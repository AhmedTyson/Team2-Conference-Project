...
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/weather/{city}`</td><td>Weather API: Current weather, temp, wind.</td><td>🌐 Public</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>POST</td><td>`/api/trips/{trip}/generate-ai`</td><td>Trigger OpenAI Itinerary Generation.</td><td>👤 Owner</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.8 Interactive Maps
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/maps/destination/{id}`</td><td>Attractions, Hotels, Restaurants Locations.</td><td>🌐 Public</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>GET</td><td>`/api/maps/trip/{id}`</td><td>Route Directions between trip itinerary points.</td><td>👤 Owner</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.9 User Dashboard
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/dashboard`</td><td>Trip Statistics & Overview.</td><td>👤 Owner</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>GET</td><td>`/api/dashboard/trips`</td><td>Saved Trips & Booking History.</td><td>👤 Owner</td><td>FUTURE SPRINTS</td></tr>
<tr><td>3</td><td>GET</td><td>`/api/dashboard/favourites`</td><td>Favorite Destinations & Places.</td><td>👤 Owner</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.10 Payments & Transactions (Pending)
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>POST</td><td>`/api/payments/checkout`</td><td>Init Stripe/PayPal booking session.</td><td>🔒 Auth</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>POST</td><td>`/api/payments/webhook`</td><td>Receive payment gateway callbacks.</td><td>🌐 Public</td><td>FUTURE SPRINTS</td></tr>
<tr><td>3</td><td>GET</td><td>`/api/transactions`</td><td>List user payment history/receipts.</td><td>👤 Owner</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.11 Admin Users
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/admin/users`</td><td>View Users.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>POST</td><td>`/api/admin/users`</td><td>Add Users.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>3</td><td>PUT</td><td>`/api/admin/users/{id}`</td><td>Edit Users.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>4</td><td>PATCH</td><td>`/api/admin/users/{id}/activate`</td><td>Activate Account.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>5</td><td>PATCH</td><td>`/api/admin/users/{id}/block`</td><td>Block Account.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.12 ✈️ Admin Trips
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/admin/trips`</td><td>View Trips.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>PUT</td><td>`/api/admin/trips/{id}`</td><td>Edit Trips.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>3</td><td>DELETE</td><td>`/api/admin/trips/{id}`</td><td>Delete Trips.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.13 Admin Destinations
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET/POST/PUT</td><td>`/api/admin/countries`</td><td>Countries CRUD.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>GET/POST/PUT</td><td>`/api/admin/destinations`</td><td>Destinations/Cities CRUD.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>3</td><td>GET/POST/PUT</td><td>`/api/admin/attractions`</td><td>Attractions CRUD.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.14 Admin Hotels & Restaurants
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET/POST/PUT</td><td>`/api/admin/hotels`</td><td>Hotels CRUD.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>GET/POST/PUT</td><td>`/api/admin/restaurants`</td><td>Restaurants CRUD.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.15 ️ Admin Categories
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET/POST/PUT</td><td>`/api/admin/categories`</td><td>Manage Beaches, Mountains, etc.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.16 Admin Reviews Moderation
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/admin/reviews`</td><td>View all reviews.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>PATCH</td><td>`/api/admin/reviews/{id}/approve`</td><td>Approve Review (Publish).</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>3</td><td>PATCH</td><td>`/api/admin/reviews/{id}/reject`</td><td>Reject Review (Hide).</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>4</td><td>DELETE</td><td>`/api/admin/reviews/{id}`</td><td>Delete Reviews.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.17 ✉️ Admin Contacts Inbox
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/admin/contacts`</td><td>Manage user inquiries.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>PATCH</td><td>`/api/admin/contacts/{id}/read`</td><td>Mark message as Read.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>3</td><td>PATCH</td><td>`/api/admin/contacts/{id}/resolve`</td><td>Mark message as Resolved.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.18 ⚙️ Admin Analytics & Settings
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/admin/analytics`</td><td>Analytics Charts (Users, Revenue).</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>GET</td><td>`/api/admin/settings`</td><td>Manage Logo, Site Name, Socials.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>3</td><td>PUT</td><td>`/api/admin/settings`</td><td>Save Settings.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>

### 1.19 Admin Reports (Pending)
<table header-row="true">
<tr><td>#</td><td>Method</td><td>Route</td><td>Description</td><td>Authorize</td><td>Backend</td></tr>
<tr><td>1</td><td>GET</td><td>`/api/admin/reports`</td><td>List generated PDF/CSV exports.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
<tr><td>2</td><td>POST</td><td>`/api/admin/reports/generate`</td><td>Generate Revenue/Growth reports.</td><td>🛡️ Admin</td><td>FUTURE SPRINTS</td></tr>
</table>
